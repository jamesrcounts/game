var board, canvas, checkCollisions, clouds, control, controls, endGame, gameLoop, toggleControls, toggleGameLoop, platforms, player, points, updatePieces, updateView;
